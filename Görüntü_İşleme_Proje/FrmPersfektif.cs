...
{
    public partial class FrmPersfektif : Form
    {
        public FrmPersfektif()
        {
            InitializeComponent();
        }
        ...
        private void BtnPersfektif_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                double y1 = Convert.ToDouble(txt_x2.Text);
                double x2 = Convert.ToDouble(txt_y1.Text);
                double y2 = Convert.ToDouble(txt_y2.Text);
                double x3 = Convert.ToDouble(txtX1.Text);
                double y3 = Convert.ToDouble(txtX2.Text);
                double x4 = Convert.ToDouble(txtY1.Text);
                double y4 = Convert.ToDouble(txtY2.Text);
                double X1 = Convert.ToDouble(txt_x3.Text);
                double Y1 = Convert.ToDouble(txt_x4.Text);
                double X2 = Convert.ToDouble(txt_y3.Text);
                double Y2 = Convert.ToDouble(txt_y4.Text);
                double X3 = Convert.ToDouble(txtX3.Text);
                double Y3 = Convert.ToDouble(txtX4.Text);
                double X4 = Convert.ToDouble(txtY3.Text);
